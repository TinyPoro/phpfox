            ...
            <div class="profile-info">
                ...
                <div class="profile-actions">
                    ...
                    <div class="profile-action-block profiles-viewer-actions">
                        ...
                        {if $aPage.showItemActions || $bCanClaim}
                        <div class="dropdown">
    ...
    <div class="profiles-menu set_to_fixed">
        <ul data-component="menu">
            ...
            <li class="profile-image-holder">
                <a href="{url link='pages.'$aPage.page_id}">
                    {if Phpfox::isModule('photo') && isset($aProfileImage) && $aProfileImage.photo_id}
                    ...
                    {else}
                        {img thickbox=true server_id=$aPage.image_server_id title=$aPage.title path='pages.url_image' file=$aPage.pages_image_path suffix='_200_square' no_default=false max_width=32 time_stamp=true}
                    {/if}
                </a>
            </li>
