...
{if $aListing.canReopenAllExpiredListing || $aListing.canReopenOwnExpiredListing}
    <li>
        <a href="javascript:void(0)" onclick="$Core.jsConfirm({left_curly}message: '{_p var='are_you_sure'}'{right_curly}, function(){left_curly} $.ajaxCall('marketplace.reopenExpiredListing','id={$aListing.listing_id}');{right_curly}, function(){left_curly}{right_curly}); return false;">
            <i class="ico ico-cart mr-1"></i>{_p var='marketplace_reopen_expired_listing'}
        </a>
    </li>
{/if}
