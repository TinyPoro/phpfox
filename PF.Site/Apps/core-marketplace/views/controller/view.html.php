        ...
        {if Phpfox::isUser() && $aListing.user_id != Phpfox::getUserId()}
            <div class="listing_purchase">
                {if $aListing.canContactSeller}
                    <button class="btn btn-primary" onclick="$Core.marketplace.contactSeller({l}id: {$aListing.user_id}, listing_id: {$aListing.listing_id}, module_id: 'marketplace'{r}); return false;">
