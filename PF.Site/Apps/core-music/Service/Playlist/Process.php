...
class Process extends Phpfox_Service
{
    ...
    public function update($iId, $aVals)
    {
        ...
        if (((($aPlaylist['user_id']['user_id'] != Phpfox::getUserId()) || (!Phpfox::getUserParam('music.can_edit_own_playlists'))) && (!Phpfox::getUserParam('music.can_edit_other_music_playlists')))) {
