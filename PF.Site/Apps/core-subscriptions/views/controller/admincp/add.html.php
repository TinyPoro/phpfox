        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="max-character">
                    ...
                    <span id="character-number-title">0</span><span>/100</span>
                </div>
                ...
                <div class="max-character">
                    <span class="warning">{_p var='Max 200 characters'}. </span>
                    <span id="character-number-description">0</span><span>/200</span>
                </div>
            ...
            <div class="form-group form-group-follow">
                ...
                <p class="help-block">
                    {_p var='Allow user to purchase the package when registering new account'}
                </p>
            </div>
            <div class="form-group form-group-follow">
            ...
            <div class="form-group form-group-follow">
                <label>{_p var='Visible for User Groups'}</label>
            ...
            <div class="form-group form-group-follow free-package">
                ...
                <span class="checkbox-title">{_p var='Free Package'}</span>
            </div>
            <div class="form-group currency">
                <label for="">{_p var='price'}</label>
                {module name='core.currency' currency_field_name='val[cost]'}
                <div class="currency-notice">{_p var='Amount you want to charge people who join this package. Check "Free Package" if you want this to be free'}</div>
            </div>
            <div class="form-group form-group-follow recurring-toggle-button">
                ...
                <p class="help-block">
                    {_p var='Choose yes if you want this subscription to be Recurring Package'}
                </p>
            </div>
        </div>
        <div class="panel-body js_recurring_body" style="{if empty($bIsEdit) && empty($aForms)}display:none;{else}{if !empty($aForms.is_recurring)}display:block;{else}display:none;{/if}{/if}">
            <div class="js_subscribe_is_recurring">
                <div class="form-group recurring-cost">
                    ...
                    <div class="currency-notice">{_p var='Amount you want to charge peopel who want to renew this package. The amount must be greater than 0'}</div>
                </div>
                <div class="from-group">
                    ...
                    <div class="notice">{_p var='Number of days before the expiration day to notify user about recurring'}</div>
                </div>
                <div class="form-group">
                    ...
                    <p class="help-block">
                        {_p var='Set the recurring period for this package'}
                    </p>
                </div>
            </div>
        </div>
