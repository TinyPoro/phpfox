...
<div class="panel panel-default core-subscription-admincp-compare-block">
    <div class="panel-heading">
        <div class="panel-title">{_p var='Comparison'}</div>
    </div>
    <div class="panel-body">
        ...
        <div class="form-group">
            <a class="btn btn-success popup" href="{url link='admincp.subscribe.add-compare'}" rel="hide_box_title" role="link">{_p var='Add New Feature'}</a>
        </div>
    </div>
</div>
