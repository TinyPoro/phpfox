            ...
            <div id="div_compare_wrapper" class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        {if Phpfox::isUser() && !empty($iPackageCompareCount) && !empty($aPackagePermissionIds)}
                            <tr>
                                ...
                                {if $aPackage.membership_permission}
                                    ...
                                    <td class="item-button">
                                        <div class="text-center wapper">
                                            <a class="btn btn-primary" href="#" onclick="{if (int)$aPackage.recurring_period > 0}tb_show('{_p var='subscribe_select_renew_method_title' phpfox_squote=true}', $.ajaxBox('subscribe.renew', 'height=400&amp;width=650&amp;id={$aPackage.package_id}'));{else}tb_show('{_p var='select_payment_gateway' phpfox_squote=true}', $.ajaxBox('subscribe.upgrade', 'height=400&amp;width=400&amp;id={$aPackage.package_id}'));{/if}">{_p var='Select Plan'}
                                            </a>
...
<div class="alert alert-empty">
    {_p var='No packages found or no feature for packages'}
</div>
{/if}
