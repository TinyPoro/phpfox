...
class Reason extends Phpfox_Service
{
    ...
    {
        db()->update(Phpfox::getT('subscribe_purchase'),['status' => 'cancel', 'time_stamp' => PHPFOX_TIME], 'purchase_id = '.$iPurchaseId);
        ...
        db()->insert(Phpfox::getT('subscribe_cancel_reason'), $aCancelReason);
    }
}