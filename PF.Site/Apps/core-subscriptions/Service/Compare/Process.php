...
class Process extends Phpfox_Service
{
    ...
    public function AddFeature($aVals)
    {
        ...
        foreach ($aLanguages as $aLanguage) {
            if (empty($aVals['feature_title'][$aLanguage['language_code']])) {
                $aVals['feature_title'][$aLanguage['language_code']] = $aVals['feature_title'][$sDefaultLanguageCode];
            }
        }
        ...
        foreach($aVals['features'] as $iPackageId => $aFeature)
        {
            ...
            if((int)$aFeature['option'] == 3)
            {
                ...
                {
                    foreach ($aLanguages as $aLanguage) {
                        if (empty($aFeature['text'][$aLanguage['language_code']])) {
                            $aFeature['text'][$aLanguage['language_code']] = $aFeature['text'][$sDefaultLanguageCode];
                        }
                    }
