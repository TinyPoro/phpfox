...
{elseif $aThread.canPurchaseSponsor}
    <li id="js_sponsor_purchase_thread_{$aThread.thread_id}">
        {if $aThread.order_id != 2}
        ...
        {elseif $aThread.order_id == 2}
        <a href="javascript:void()" onclick="$.ajaxCall('forum.sponsor','thread_id={$aThread.thread_id}&type=0');return false;">
            <i class="ico ico-sponsor mr-1"></i>{_p var='unsponsor'}
        </a>
        {/if}
    </li>
