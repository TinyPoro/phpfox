...
class Install extends App\App
{
    ...
    protected function setUserGroupSettings()
    {
        $this->user_group_settings = [
            ...
            'can_admin_adjust_activity_points' => [
                ...
                'info' => 'Allow users of this group using function "Send/Minus Activity Points"',
                'description' => 'if enabled, Admin will be allowed to send or minus activity points for members, or multi members in the community',
                'type' => 'boolean',
                'value' => [
                    '1' => '1',
                    '2' => '1',
            ...
            'maximum_activity_points_admin_can_adjust' => [
                ...
                'info' => 'Maximum Activity Points that this user group will send',
                'description' => '',
                'type' => 'integer',
                'value' => [
                    '1' => '1000',
            ...
            'period_time_admin_adjust_activity_points' => [
                ...
                'info' => 'Period for sending Activity Point',
                'description' => '',
                'type' => 'select',
                'value' => 'per_day',
                'options' => [
    ...
    protected function setOthers()
    {
        $this->admincp_menu = [
            _p('Points Setting') => '#',
            _p('Points Package') => 'activitypoint.package',
            _p('Transaction History') => 'activitypoint.transaction',
            _p('Member Points') => 'activitypoint.point'
        ];
