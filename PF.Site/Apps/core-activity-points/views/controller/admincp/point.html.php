            ...
            <div class="table-responsive">
                <table class="table" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td class="t_center">{$aMemberPoint.activity_points}</td>
                        <td class="t_center">{$aMemberPoint.total_earned}</td>
                        <td class="t_center">{$aMemberPoint.total_received}</td>
                        <td class="t_center">{$aMemberPoint.total_bought}</td>
                        <td class="t_center">{$aMemberPoint.total_spent}</td>
                        <td class="t_center">{$aMemberPoint.total_sent}</td>
                        <td class="t_center">
