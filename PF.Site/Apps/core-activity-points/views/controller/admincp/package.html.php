            ...
            {if !empty($bEmpty)}
                ...
                <div class="table-responsive">
                    <table class="table" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td class="t_center">
                                <a href="{url link='admincp.activitypoint.add-package' id=$aPackage.package_id}" class="popup">{$aPackage.package_id}</a>
                            </td>
                            ...
                            <td class="t_center">
                                ...
                                <a href="{url link='admincp.activitypoint.package' delete=$aPackage.package_id}" class="sJsConfirm">
                                    {_p var='Delete'}
                                </a>
                                {/if}
                            </td>
