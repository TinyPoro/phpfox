                ...
                <table class="table" cellpadding="0" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th class="t_center w120">{_p var='activitypoint_app'}</th>
                            <th class="t_center">{_p var='activitypoint_admincp_index_action'}</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center">{$aTransaction.transaction_id}</td>
                            ...
                            <td class="text-center">{_p var=$aTransaction.module_title}</td>
                            <td class="text-center">{$aTransaction.phrase}</td>
                            <td class="text-center">{$aTransaction.points}</td>
                        </tr>
                        {/foreach}
                    </tbody>
                </table>
