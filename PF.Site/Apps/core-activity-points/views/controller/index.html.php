        ...
        <div class="statistic-wrapper-left">
            <div class="item-statistic-with-icon">
                ...
                <div class="item-inner">
                    ...
                    <div class="item-number">{$aStatistics.current_points.points}</div>
                </div>
            </div>
            <div class="statistic-list-mini">
                ...
                <div class="item-list-number">
                    <div class="item-number">{$aStatistics.earned_points.points}</div>
                    <div class="item-number">{$aStatistics.bought_points.points}</div>
                    <div class="item-number">{$aStatistics.received_points.points}</div>
                </div>
            </div>
        </div>
        <div class="statistic-wrapper-right">
            <div class="item-statistic-with-icon">
                ...
                <div class="item-inner">
                    ...
                    <div class="item-number">{$aStatistics.spent_points.points}</div>
                </div>
            </div>
            <div class="item-statistic-with-icon">
                ...
                <div class="item-inner">
                    ...
                    <div class="item-number">{$aStatistics.sent_points.points}</div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="table-responsive core-activitypoint-table transaction-table">
                <table class="table" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class=""><div class="td-content">{$aTransaction.transaction_id}</div></td>
                            ...
                            <td class=""><div class="td-content">{$aTransaction.phrase}</div></td>
                            <td class="t_center"><div class="td-content center">{$aTransaction.points}</div></td>
                        </tr>
                        {/foreach}
                    </tbody>
                </table>
