    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="custom-radio-wrapper">
                    <label>
                        <input type="radio" value="2" name="val[type_id]" id="type_html" class="type_id" {value type='radio' id='type_id' default='1' }>
                        <span class="custom-radio"></span>
                        {_p var='html'}
                    </label>
                </div>
            ...
            <div class="form-group" {if ($bIsEdit && !\Phpfox::isAdminPanel())} style="display:none;" {/if}>
                ...
                <select name="val[location]" id="better_ads_location" class="form-control">
                    ...
                    <option value="{$aPlan.plan_id}" {value type='select' id='location' default=$aPlan.plan_id} data-block-id="{$aPlan.block_id}">
            ...
            <div class="form-group {if !$bIsEdit || $aForms.type_id==1}hide{/if}" data-type="html">
            ...
            <div id="ad_details" {if !$bIsEdit}class="hide"{/if}>
                ...
                <div class="form-group" id="js_total_click" data-type="image">
                    <div class="custom-checkbox-wrapper checkbox-input">
                        <label>
                ...
                <div class="form-group">
                    ...
                    <a role="button" class="btn btn-default js_betterads_preview_exist_ad" data-ad-id="{$aForms.ads_id}" data-location="{$aForms.location}" title="{_p var='preview'}">{_p var='preview'}</a>
                </div>
            </div>
        </div>
    </div>
