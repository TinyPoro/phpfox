<div class="poll-app feed {if empty($aPoll.image_path)}no-photo{/if}">
	...
	<div class="poll-inner pl-2 pr-2">
		<a href="{if $bIsSponsorFeed && $iSponsorId}{url link='ad.sponsor' view=$iSponsorId}{else}{permalink id=$aPoll.poll_id module='poll' title=$aPoll.question}{/if}" class="poll-title fw-bold">{$aPoll.question|clean}</a>
