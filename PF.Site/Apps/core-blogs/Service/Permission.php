...
class Permission extends \Phpfox_Service
{
    ...
    public function canSponsorInFeed($aBlog)
    {
        ...
        if (Phpfox::isAppActive('Core_BetterAds') && Phpfox::isModule('feed') && (($aBlog['user_id'] == Phpfox::getUserId() && Phpfox::getUserParam('feed.can_purchase_sponsor')) || Phpfox::getUserParam('feed.can_sponsor_feed')) && Phpfox::getService('feed')->canSponsoredInFeed('blog', $aBlog['blog_id'])) {
            return true;
        }
    ...
    {
        if (Phpfox::isAppActive('Core_BetterAds') && Phpfox::getUserParam('blog.can_sponsor_blog')) {
            return true;
        }
    ...
    public function canPurchaseSponsor($aBlog)
    {
        ...
        if (Phpfox::isAppActive('Core_BetterAds') && $aBlog['user_id'] == Phpfox::getUserId() && Phpfox::getUserParam('blog.can_purchase_sponsor') && $bIsNotPendingItem) {
            return true;
        }
