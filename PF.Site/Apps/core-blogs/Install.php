    ...
    protected function setSettings()
    {
        ...
        $this->settings = [
            ...
            'allow_create_feed_when_add_new_item' => [
                'var_name' => 'allow_create_feed_when_add_new_item',
...
If set to No, the admin will have to approve each new purchased sponsored item space before it is shown in the site.',
            ...
            'blog_photo_max_upload_size' => [
                ...
                'description' => 'Max file size for photo of blog upload in kilobits (kb). <br> (1024 kb = 1 mb) <br> For unlimited add "0" without quotes.',
                'type' => 'integer',
                'value' => 8192,
            ]
        ];
