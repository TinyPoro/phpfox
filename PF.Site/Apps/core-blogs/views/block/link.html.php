...
<li>
    {if Phpfox::isModule('feed') && Phpfox::getService('feed')->canSponsoredInFeed('blog', $aItem.blog_id) === true}
...
{if $aItem.canSponsor || $aItem.canFeature || $aItem.canPurchaseSponsor}
    ...
    {elseif $aItem.canPurchaseSponsor}
        <li>
            ...
            {else}
            <a title="{_p var='unsponsor_this_blog'}" href="javascript:void(0)" onclick="$.ajaxCall('blog.unSponsor','blog_id={$aItem.blog_id}'); return false;">
                <span class="ico ico-sponsor mr-1"></span>{_p var='unsponsor_this_blog'}
            </a>
            {/if}
        </li>
