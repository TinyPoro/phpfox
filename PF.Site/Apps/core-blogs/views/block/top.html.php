	...
	<li>
        <div class="blog-row checkRow table_row {if $index == 0}blogger-1st{/if}">
            ...
            <div class="blogger-cover">
                <span style="background-image: url({if empty($aTopBlogger.cover_default)}{img return_url=true server_id=$aTopBlogger.cover_server_id path='photo.url_photo' file=$aTopBlogger.cover_destination suffix='_240'}{else}{$aTopBlogger.cover_default}{/if})"></span>
            </div>
            {else}
