                    ...
                    <div class="group-avatar">
                        <a href="{if $aAnother.vanity_url}{url link=$aAnother.vanity_url}{else}{url link='groups'}{$aAnother.page_id}{/if}" title="{$aAnother.title}">
                            <div class="img-wrapper">
                                {img server_id=$aAnother.image_server_id title=$aAnother.title path='pages.url_image' file=$aAnother.image_path suffix='_50_square' max_width='50' max_height='50' is_page_image=true}
                            </div>
                        </a>
                    </div>
