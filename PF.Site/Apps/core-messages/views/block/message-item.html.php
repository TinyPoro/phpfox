...
<li class="core-messages__list-item d-flex align-items-center  mail_holder{if !$bIsSentbox && !$bIsTrash && $aMail.viewer_is_new} mail_is_new{/if} {if (int)$mailkey == 0}is_selected_thread{/if}"  id="js_message_{$aMail.thread_id}">
