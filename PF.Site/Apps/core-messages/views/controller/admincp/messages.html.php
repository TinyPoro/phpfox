...
<div class="core-messages-admincp-messages">
    <div class="advanced-search">
        <form id="js_form_messsages_search" method="get" action="{url link='current'}">
        ...
        <div class="panel panel-default table-responsive">
            ...
            <table class="table table-admin" id="_sort" data-sort-url="{url link='subscribe.admincp.order' table='subscribe_package' field='package_id'}">
                ...
                <tr>
                    ...
                    <th class="t_center w180">{_p var='Member Name'}</th>
                    <th class="t_center w180">{_p var='Message'}</th>
                ...
                <tr>
                    ...
                    <td class="t_center mail_text w180" style="word-break: break-all;word-wrap: break-word;">
                        {$aMessage.text}
    ...
    <div class="mass-actions col-md-12">
        <div class="left">
            ...
            <button class="btn btn-success" id="js_unselect_all">{_p var='Unselect All'}</button>
        </div>
        <div class="right">
            {if Phpfox::getUserParam('mail.can_delete_others_messages')}
                <button class="btn btn-danger" id="js_delete_messages" data-id="{$iId}">{_p var='Delete'}</button>
            {/if}
            <button class="btn btn-default" id="js_hidden_messages" data-id="{$iId}">{_p var='Hide'}</button>
        </div>
    </div>
    {/if}
</div>
