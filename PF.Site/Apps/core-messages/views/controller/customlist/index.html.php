        ...
        <div class="core-messages__left-side">
            <div class="core-messages__search">
                <form action="{url link='mail.customlist'}" method="get" id="js_form_custom_list_search" class="w-full">
                    <input type="text" name="search[name]" class="form-control input-sm core-messages__search-input {if !empty($aForms.name)}search-page{/if}" id="js_search_name" placeholder="{_p var='Search list...'}" value="{value type='input' id='name'}">
                </form>
            ...
            <div class="back-parent d-flex">
                <div class="core-messages__filter-back d-inline-flex align-items-center"><a class="fa fa-angle-left" href="{url link='mail'}" title="{_p var='Back'}"></a><span class="fw-bold">{_p var='Custom List'}</span></div>
            </div>
            {if $iTotal}
