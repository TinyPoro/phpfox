            ...
            <div class="core-messages-advanced-compose">
                <div class="search-friend-component mb-1">
                    ...
                    <div id="js_core_messages_custom_search_friend">
                        <input type="text" id="js_core_messages_search" class="search_friend_input" placeholder="Search friends, custom list by name..." autocomplete="off" onfocus="coreMessages.search.buildList();" onkeyup="coreMessages.search.getSearch(this);" style="width:100%;" class="form-control" >
