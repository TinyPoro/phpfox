        ...
        <div class="core-messages__left-side">
            <div class="core-messages__search">
                <form id="js_message_filter" class="w-full" method="GET" action="{url link='mail'}">
                    ...
                    <input class="form-control input-sm core-messages__search-input {if !empty($aForms.title)}search-page{/if}" type="text" id="js_search_title" name="search[title]" placeholder="{_p var='Search conversation'}" value="{value type='input' id='title'}">
                </form>
