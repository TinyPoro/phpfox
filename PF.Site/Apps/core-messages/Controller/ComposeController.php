...
class ComposeController extends Phpfox_Component
{
    ...
    public function process()
    {
        ...
        if (($aVals = $this->request()->getArray('val')))
        {
            ...
            {
                Phpfox_Error::set(_p('Select members or custom list to send message'));
            }
            ...
            {
                Phpfox_Error::set(_p('Number of members for group you creating is over the limitation. The limitation number is ').setting('mail.chat_group_member_maximum').'.');
            }
