...
{elseif $aQuiz.canPurchaseSponsor}
    {if $aQuiz.is_sponsor == 1}
        <li>
            <a href="#" onclick="$('#js_sponsor_phrase_{$aQuiz.quiz_id}').hide(); $('#js_sponsor_{$aQuiz.quiz_id}').hide();$('#js_unsponsor_{$aQuiz.quiz_id}').show();$.ajaxCall('quiz.sponsor','quiz_id={$aQuiz.quiz_id}&type=0', 'GET'); return false;">
                <span class="ico ico-sponsor mr-1"></span>{_p('unsponsor_this_quiz')}
            </a>
        </li>
    {else}
        <li>
