<article class="photo-listing-item" data-url="{$aForms.link}" data-photo-id="{$aForms.photo_id}" id="js_photo_id_{$aForms.photo_id}" data-class="{if !$aForms.can_view}photo-mature{/if}">
