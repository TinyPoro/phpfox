...
<div class="video-view ">
    ...
    {if !empty($aItem.text)}
        <div class="video-content item_view_content">
            ...
            {$aItem.text|parse|shorten:200:'view_more':true}
        </div>
    {/if}
    ...
    {if Phpfox::isModule('feed') &&  Phpfox::getParam('feed.enable_check_in') && Phpfox::getParam('core.google_api_key') != '' && isset($aItem.location_name)}
