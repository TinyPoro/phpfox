...
class Callback extends Phpfox_Service
{
    ...
    public function getActivityFeed($aItem, $aCallback = null, $bIsChildItem = false)
    {
        ...
        $iSponsorId = Phpfox::isAppActive('Core_BetterAds') && (int)$aItem['feed_id'] === (int)$aItem['sponsor_feed_id'] ? Phpfox::getService('ad.get')->getFeedSponsors($aItem['feed_id']) : 0 ;
        $aReturn = array(
    ...
    public function addComment($aVals, $iUserId = null, $sUserName = null)
    {
        ...
        $aSubject = (Phpfox::getUserId() == $aVideo['user_id'] ? array('full_name_commented_on_gender_video',
            array(
                'full_name' => Phpfox::getUserBy('full_name'),
                'gender' => Phpfox::getService('user')->gender($aVideo['gender'], 1)
            )) : array('full_name_commented_on_video_full_name_s_video',
            array('full_name' => Phpfox::getUserBy('full_name'), 'video_full_name' => $aVideo['full_name'])));
        $aMessage = (Phpfox::getUserId() == $aVideo['user_id'] ? array('full_name_commented_on_gender_video_message',
            array(
                'full_name' => Phpfox::getUserBy('full_name'),
                'gender' => Phpfox::getService('user')->gender($aVideo['gender'], 1),
                'link' => $aVideo['link'],
                'title' => $aVideo['title']
            )) : array('full_name_commented_on_video_full_name_s_video_message', array(
                    'full_name' => Phpfox::getUserBy('full_name'),
        ...
        Phpfox::getService('comment.process')->notify(array(
                ...
                'owner_subject' => array('full_name_commented_on_your_video_title',
                    array('full_name' => Phpfox::getUserBy('full_name'), 'title' => $aVideo['title'])),
                'owner_message' => array('full_name_commented_on_your_video_message',
                    array(
                        'full_name' => Phpfox::getUserBy('full_name'),
                        'link' => $aVideo['link'],
                        'title' => $aVideo['title']
        ...
        if ($aVideo['module_id'] == 'user') {
            ...
            Phpfox::getService('comment.process')->notify(array(
                    ...
                    'notify_id' => 'comment_v',
                    'mass_id' => 'video',
                    'mass_subject' => (Phpfox::getUserId() == $aVideo['item_id'] ? array('full_name_commented_on_gender_video',
                        array(
                            'full_name' => Phpfox::getUserBy('full_name'),
                            'gender' => Phpfox::getService('user')->gender($aVideo['gender'], 1)
                        )) : array('full_name_commented_on_video_full_name_s_video',
                    ...
                    'mass_message' => (Phpfox::getUserId() == $aVideo['item_id'] ? array('full_name_commented_on_gender_video_message',
                        array(
                            'full_name' => Phpfox::getUserBy('full_name'),
                            'gender' => Phpfox::getService('user')->gender($aVideo['gender'], 1),
                            'link' => $aVideo['link'],
