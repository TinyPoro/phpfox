...
class Objectify
{
    ...
    protected function _build($row)
    {
        ...
        if (!empty($row['user_image'])) {
            $image_120px = \Phpfox_Image_Helper::instance()->display([
                'user'       => $row,
                'suffix'     => '_120_square',
                'return_url' => true,
            ]);
        ...
        return [
            ...
            'photo'      => [
                '50px'     => str_replace('_120_square', '_50_square', $image_120px),
                '120px'    => $image_120px,
                '200px'    => str_replace('_120_square', '_200_square', $image_120px),
                'original' => str_replace('_120_square', '', $image_120px),
            ],
            'location'   => [
                'iso' => $row['country_iso'],
            ],
