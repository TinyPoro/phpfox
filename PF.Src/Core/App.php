...
class App
{
    ...
    public function __construct($refresh = false)
    {
        ...
        if ($refresh and $settings) {
            ...
            new Setting($cache->getLocalFirst('app_settings'));
        }
    ...
    {
        if (self::$activeApps === null) {
            self::getActivatedApps();
        }

        if (!empty(self::$activeApps)) {
            return in_array($sAppId, self::$activeApps);
        }
        return false;
    }
    ...
    public static function getActivatedApps()
    {
        ...
        if (empty(self::$activeApps)) {
            self::$activeApps = get_from_cache('app_is_active', function() {
