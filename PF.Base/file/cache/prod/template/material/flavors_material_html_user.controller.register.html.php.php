...
<?php /* Cached: November 19, 2018, 11:53 am */ ?>
<?php
...
<script type="text/javascript">
    $Behavior.termsAndPrivacy = function()
    {
        $(\'#js_terms_of_use\').click(function()
        {
            ...
            tb_show('<?php echo _p('terms_of_use', array('phpfox_squote' => true)); ?>', $.ajaxBox('page.view', 'height=410&width=600&title=terms'));
            <?php echo '
            return false;
        });
        ...
        $(\'#js_privacy_policy\').click(function()
        {
            ...
            tb_show('<?php echo _p('privacy_policy', array('phpfox_squote' => true)); ?>', $.ajaxBox('page.view', 'height=410&width=600&title=policy'));
            <?php echo '
            return false;
        });
    }
...
<?php endif; ?>
                    ...
                    <div class="form-button-group register-form-button-group">
                        <div class="form-group">
<?php if (isset ( $this->_aVars['bIsPosted'] ) || ! Phpfox ::getParam('user.multi_step_registration_form')): ?>
                                <button type="submit" class="btn btn-primary" id="js_registration_submit"><?php echo _p('sign_up_button'); ?></button>
<?php else: ?>
                                <input type="button" value="<?php echo _p('sign_up_button'); ?>" class="btn btn-success text-uppercase" id="js_registration_submit" onclick="$Core.registration.submitForm();" />
<?php endif; ?>
                        </div>
