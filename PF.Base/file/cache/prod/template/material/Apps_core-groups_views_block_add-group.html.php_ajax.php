...
<?php if (! empty ( $this->_aVars['aMainCategory']['image_path'] )): ?>
...
<?php endif; ?>
    ...
    <div class="form-group col-xs-12 group-category-input">
        <label for="title" class=""><?php echo _p("group_name"); ?></label>
        <div>
    ...
    <div class="form-group col-xs-12 group-privacy-select">
        <label for="group-type" class=""><?php echo _p("type_privacy"); ?></label>
        <select name="val[reg_method]" class="form-control" id="group-type">
            <option value="0"><?php echo _p('public_group'); ?></option>
            <option value="1"><?php echo _p('closed_group'); ?></option>
            <option value="2"><?php echo _p('secret_group'); ?></option>
        </select>
    </div>

    <div class="group-category-button">
        <input type="submit" class="btn btn-primary btn-round" value="<?php echo _p('create_group'); ?>">
