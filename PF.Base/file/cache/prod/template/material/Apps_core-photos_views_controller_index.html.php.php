...
<?php if (! isset ( $this->_aVars['bIsEditMode'] ) && count ( $this->_aVars['aPhotos'] )): ?>
        <div class="photo-mode-view-container core-photos-js" id="<?php echo $this->_aVars['sView']; ?>-photos">
...
<?php endif; ?>
    <div id="js_actual_photo_content" class="photo-mode-view-content photo-view-modes-js" data-mode-view="grid" data-mode-view-default="casual">
