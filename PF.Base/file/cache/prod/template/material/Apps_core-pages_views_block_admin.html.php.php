...
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('user' => $this->_aVars['aPageAdmin'],'suffix' => '_120_square')); ?>
        </div>
        <div class="user_rows_inner">
<?php echo '<span class="user_profile_link_span" id="js_user_name_link_' . $this->_aVars['aPageAdmin']['user_name'] . '">' . (Phpfox::getService('user.block')->isBlocked(null, $this->_aVars['aPageAdmin']['user_id']) ? '' : '<a href="' . Phpfox::getLib('phpfox.url')->makeUrl('profile', array($this->_aVars['aPageAdmin']['user_name'], ((empty($this->_aVars['aPageAdmin']['user_name']) && isset($this->_aVars['aPageAdmin']['profile_page_id'])) ? $this->_aVars['aPageAdmin']['profile_page_id'] : null))) . '">') . '' . Phpfox::getLib('phpfox.parse.output')->shorten(Phpfox::getService('user')->getCurrentName($this->_aVars['aPageAdmin']['user_id'], $this->_aVars['aPageAdmin']['full_name']), 40, '...') . '' . (Phpfox::getService('user.block')->isBlocked(null, $this->_aVars['aPageAdmin']['user_id']) ? '' : '</a>') . '</span>'; ?>
