...
<?php if (count((array)$this->_aVars['aMutualFriends'])):  $this->_aPhpfoxVars['iteration']['friend'] = 0;  foreach ((array) $this->_aVars['aMutualFriends'] as $this->_aVars['iKey'] => $this->_aVars['aUser']):  $this->_aPhpfoxVars['iteration']['friend']++; ?>
