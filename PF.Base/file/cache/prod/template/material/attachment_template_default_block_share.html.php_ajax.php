        ...
        <div class="global_attachment_header">
            <div class="global_attachment_manage">
                <a class="border_radius_4" role="button" onclick="$Core.Attachment.toggleAttachmentForm(this)" id="attachment-toggle-button">
                    <span class="ico ico-paperclip-alt"></span> <?php echo _p('attachments'); ?> <span class="attachment-counter"><?php if (! empty ( $this->_aVars['aForms']['total_attachment'] )): ?>(<?php echo $this->_aVars['aForms']['total_attachment']; ?>)<?php else: ?>(0)<?php endif; ?></span>
