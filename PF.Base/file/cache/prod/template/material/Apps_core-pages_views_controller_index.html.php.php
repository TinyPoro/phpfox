...
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('server_id' => $this->_aVars['aPage']['profile_server_id'],'title' => $this->_aVars['aPage']['title'],'path' => 'pages.url_image','file' => $this->_aVars['aPage']['image_path'],'suffix' => '_200_square','max_width' => '200','max_height' => '200','is_page_image' => true)); ?>
                                    ...
                                    <a class="item-desc" href="<?php echo $this->_aVars['aPage']['link']; ?>">
                                        <div class="item-desc-main"><?php echo Phpfox::getLib('phpfox.parse.output')->clean(Phpfox::getLib('phpfox.parse.bbcode')->stripCode(strip_tags($this->_aVars['aPage']['text_parsed']))); ?></div>
                                    </a>
                                </div>
                                    ...
                                    <div class="item-option page-button-option">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right" id="js_page_entry_options_<?php echo $this->_aVars['aPage']['page_id']; ?>">
                                                <?php
						Phpfox::getLib('template')->getBuiltFile('pages.block.link-listing');
						?>
                                            </ul>
                                        </div>
                                    </div>
...
<div class="message">
<?php echo _p('note_that_pages_displayed_here_are_pages_created_by_the_page', array('global_full_name' => Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['sGlobalUserFullName']),'profile_full_name' => Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aGlobalProfilePageLogin']['full_name']))); ?>
</div>
...
<?php endif; ?>
            ...
            <div class="item-inner">
                <div class="item-title">
                    <a href="<?php echo $this->_aVars['aPage']['url']; ?>" class="link pages_title "><?php echo Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aPage']['title']); ?></a>
                </div>
                <div class="item-info">
