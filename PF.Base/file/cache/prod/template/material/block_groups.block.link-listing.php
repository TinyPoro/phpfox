...
<?php
 ...
 if ($this->_aVars['aPage']['bCanApprove']): ?>
<li><a href="#" onclick="$.ajaxCall('groups.approve', 'page_id=<?php echo $this->_aVars['aPage']['page_id']; ?>');"><span class="ico ico-check-square-alt mr-1"></span><?php echo _p('approve'); ?></a></li>
<?php endif;  if ($this->_aVars['aPage']['bCanEdit']): ?>
...
<li class="item_delete">
    <a href="<?php if (isset ( $this->_aVars['iCurrentProfileId'] )):  echo Phpfox::getLib('phpfox.url')->makeUrl('groups', array('delete' => $this->_aVars['aPage']['page_id'],'profile' => $this->_aVars['iCurrentProfileId']));  else:  echo Phpfox::getLib('phpfox.url')->makeUrl('groups', array('delete' => $this->_aVars['aPage']['page_id']));  endif; ?>" data-message="<?php echo _p('are_you_sure_you_want_to_delete_this_group_permanently'); ?>" class="no_ajax_link sJsConfirm">
