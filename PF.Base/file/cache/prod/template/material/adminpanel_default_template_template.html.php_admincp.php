...
<?php if (! Phpfox ::demoModeActive()): ?>
                <div class="admincp_view_site">
                    <a target="_blank" href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl(''); ?>"><?php echo _p('view_site'); ?>&nbsp;<i class="fas fa fa-external-link"></i></a>
                </div>
<?php endif; ?>
            </div>
...
<?php if (! empty ( $this->_aVars['aSectionAppMenus'] ) && count ( $this->_aVars['aSectionAppMenus'] ) <= 6): ?>
...
<?php if (isset ( $this->_aVars['aSectionAppMenus'] ) && count ( $this->_aVars['aSectionAppMenus'] ) > 6): ?>
                <div class="btn-group acp-header-section">
