...
<?php endif;  if (count((array)$this->_aVars['aEvents'])):  foreach ((array) $this->_aVars['aEvents'] as $this->_aVars['sDate'] => $this->_aVars['aGroups']): ?>
<?php if (count((array)$this->_aVars['aGroups'])):  $this->_aPhpfoxVars['iteration']['events'] = 0;  foreach ((array) $this->_aVars['aGroups'] as $this->_aVars['aEvent']):  $this->_aPhpfoxVars['iteration']['events']++; ?>
		...
		<?php
						...
						?>
<?php endforeach; endif;  endforeach; endif;  if (!isset($this->_aVars['aPager'])): Phpfox::getLib('pager')->set(array('page' => Phpfox::getLib('request')->getInt('page'), 'size' => Phpfox::getLib('search')->getDisplay(), 'count' => Phpfox::getLib('search')->getCount())); endif;  $this->getLayout('pager'); ?>
<!--		end foreach2-->
