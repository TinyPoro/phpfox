...
<?php if (count((array)$this->_aVars['aInvites'])):  $this->_aPhpfoxVars['iteration']['invites'] = 0;  foreach ((array) $this->_aVars['aInvites'] as $this->_aVars['aUser']):  $this->_aPhpfoxVars['iteration']['invites']++; ?>
...
<?php if ($this->_aVars['iRsvp'] == 1): ?>
<?php echo _p('no_attendees'); ?>
<?php else: ?>
<?php echo _p('no_results'); ?>
<?php endif; ?>
            </div>
<?php endif; ?>
<?php endif; ?>
