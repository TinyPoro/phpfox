...
<?php if ($this->_aVars['bCanClaim']): ?>
<li>
    <a href="#?call=contact.showQuickContact&amp;height=600&amp;width=600&amp;page_id=<?php echo $this->_aVars['aPage']['page_id']; ?>" class="inlinePopup" title="<?php echo _p('claim_page'); ?>">
        <span class="ico ico-compose-alt"></span>
<?php echo _p('claim_page'); ?>
    </a>
</li>
<?php endif;  if ($this->_aVars['aPage']['canEdit']): ?>
<li>
    <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('pages.add', array('id' => $this->_aVars['aPage']['page_id'])); ?>">
...
<li class="item_delete">
    <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('pages', array('delete' => $this->_aVars['aPage']['page_id'])); ?>" data-message="<?php echo _p('are_you_sure'); ?>" class="no_ajax_link sJsConfirm">
        <span class="ico ico-trash-alt-o mr-1"></span>
<?php echo _p('delete_this_page'); ?>
    </a>
</li>
<?php endif; ?>
