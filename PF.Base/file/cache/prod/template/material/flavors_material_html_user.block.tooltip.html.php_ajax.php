...
<?php /* Cached: November 20, 2018, 10:48 am */ ?>
<?php 
...
<?php endif; ?>
	<ul>
<?php if (Phpfox ::isUser() && Phpfox ::isModule('friend') && Phpfox ::getUserParam('friend.can_add_friends') && empty ( $this->_aVars['aUser']['is_friend'] )): ?>
