...
<?php elseif ($this->_aVars['aItem']['type_id'] == 'big_string'): ?>
                <textarea class="form-control" rows="8" name="val[value_actual][<?php echo $this->_aVars['aItem']['setting_id']; ?>]"><?php echo $this->_aVars['aItem']['value_actual']; ?></textarea>
<?php elseif (( $this->_aVars['aItem']['type_id'] == 'integer' || $this->_aVars['aItem']['type_id'] == 'string' || $this->_aVars['aItem']['type_id'] == 'input:text' )): ?>
                <input class="form-control" type="text" name="val[value_actual][<?php echo $this->_aVars['aItem']['setting_id']; ?>]" value="<?php echo $this->_aVars['aItem']['value_actual']; ?>" size="25" onclick="this.select();" />
<?php elseif (( $this->_aVars['aItem']['type_id'] == 'boolean' || $this->_aVars['aItem']['type_id'] == 'input:radio' )): ?>
                <div class="item_is_active_holder">
                    <span class="js_item_active item_is_active hide">
                        <input type="radio" class="radio_yes" name="val[value_actual][<?php echo $this->_aVars['aItem']['setting_id']; ?>]" value="1" <?php if ($this->_aVars['aItem']['value_actual'] == true || $this->_aVars['aItem']['value_actual'] == "1"): ?>data-it="1yes" checked="checked" <?php endif; ?>/>
                    </span>
                    <span class="js_item_active item_is_not_active hide">
                        <input type="radio" class="radio_no" name="val[value_actual][<?php echo $this->_aVars['aItem']['setting_id']; ?>]" value="0" <?php if (! $this->_aVars['aItem']['value_actual']): ?>checked="checked" <?php endif; ?>/>
                    </span>
                </div>
...
<?php if (count((array)$this->_aVars['aItem']['value_actual'])):  foreach ((array) $this->_aVars['aItem']['value_actual'] as $this->_aVars['mKey'] => $this->_aVars['sDropValue']): ?>
                <div class="p_4">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="text" name="val[value_actual][<?php echo $this->_aVars['aItem']['setting_id']; ?>][<?php echo $this->_aVars['mKey']; ?>]" value="<?php echo Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['sDropValue']); ?>" />
                    </div>
                </div>
<?php endforeach; endif; ?>
<?php elseif ($this->_aVars['aItem']['type_id'] == 'drop' || $this->_aVars['aItem']['type_id'] == 'drop_with_key' || $this->_aVars['aItem']['type_id'] == 'select'): ?>
                <select name="val[value_actual][<?php echo $this->_aVars['aItem']['setting_id']; ?>]" class="form-control">
...
<?php if (count((array)$this->_aVars['aItem']['value_actual'])):  foreach ((array) $this->_aVars['aItem']['value_actual'] as $this->_aVars['iKey'] => $this->_aVars['sValue']): ?>
                    <div class="p_4 js_array<?php echo $this->_aVars['iKey']; ?>">
                        <div class="input-group">
                            <input type="text" name="val[value_actual][<?php echo $this->_aVars['aItem']['setting_id']; ?>][]" value="<?php echo $this->_aVars['sValue']; ?>" size="120" class="form-control" />
