...
<?php if (count((array)$this->_aVars['aLastAdmins'])):  $this->_aPhpfoxVars['iteration']['lastadmins'] = 0;  foreach ((array) $this->_aVars['aLastAdmins'] as $this->_aVars['aLastAdmin']):  $this->_aPhpfoxVars['iteration']['lastadmins']++; ?>
    ...
    <tr>
        <td>
<?php echo '<span class="user_profile_link_span" id="js_user_name_link_' . $this->_aVars['aLastAdmin']['user_name'] . '">' . (Phpfox::getService('user.block')->isBlocked(null, $this->_aVars['aLastAdmin']['user_id']) ? '' : '<a href="' . Phpfox::getLib('phpfox.url')->makeUrl('profile', array($this->_aVars['aLastAdmin']['user_name'], ((empty($this->_aVars['aLastAdmin']['user_name']) && isset($this->_aVars['aLastAdmin']['profile_page_id'])) ? $this->_aVars['aLastAdmin']['profile_page_id'] : null))) . '">') . '' . Phpfox::getLib('phpfox.parse.output')->shorten(Phpfox::getService('user')->getCurrentName($this->_aVars['aLastAdmin']['user_id'], $this->_aVars['aLastAdmin']['full_name']), 0) . '' . (Phpfox::getService('user.block')->isBlocked(null, $this->_aVars['aLastAdmin']['user_id']) ? '' : '</a>') . '</span>'; ?>
            <br/>
