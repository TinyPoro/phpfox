...
<?php if (count((array)$this->_aVars['aCountries'])):  foreach ((array) $this->_aVars['aCountries'] as $this->_aVars['sIso'] => $this->_aVars['sCountryName']): ?>
            <option class="js_country_option" id="js_country_iso_option_<?php echo $this->_aVars['sIso']; ?>" value="<?php echo $this->_aVars['sIso']; ?>"><?php echo $this->_aVars['sCountryName']; ?></option>
<?php endforeach; endif; ?>

</select>

<?php if (isset ( $this->_aVars['country_iso'] )): ?>
