...
<?php /* Cached: November 21, 2018, 4:48 am */ ?>
<?php

 if (! empty ( $this->_aVars['bShowCategories'] )):  if (count ( $this->_aVars['aCategories'] )):  if (count((array)$this->_aVars['aCategories'])):  foreach ((array) $this->_aVars['aCategories'] as $this->_aVars['aCategory']):  if ($this->_aVars['aCategory']['pages']): ?>
                        ...
                        <div class="item-option group-button-option">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" id="js_group_entry_options_<?php echo $this->_aVars['aPage']['page_id']; ?>">
                                    <?php
						Phpfox::getLib('template')->getBuiltFile('groups.block.link-listing');
						?>
                                </ul>
                            </div>
                        </div>
...
<?php endif;  endforeach; endif;  endif;  if ($this->_aVars['iCountPage'] == 0): ?>
...
<?php if (! empty ( $this->_aVars['bShowModeration'] )):  Phpfox::getBlock('core.moderation');  endif; ?>
