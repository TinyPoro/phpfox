							...
							
{
							...
							?>
><?php if ($this->_aVars['aPackage']['show_price']): ?>(<?php if ($this->_aVars['aPackage']['default_cost'] == '0.00'):  echo _p('free');  else:  echo Phpfox::getService('core.currency')->getSymbol($this->_aVars['aPackage']['default_currency_id']);  echo $this->_aVars['aPackage']['default_cost'];  endif; ?>) <?php endif;  echo Phpfox::getLib('phpfox.parse.output')->clean(Phpfox::getLib('locale')->convert($this->_aVars['aPackage']['title'])); ?></option>
<?php endforeach; endif; ?>
		</select>
