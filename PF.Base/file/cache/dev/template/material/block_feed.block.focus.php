...
<div class="activity_feed_content_text<?php if (isset ( $this->_aVars['aFeed']['comment_type_id'] ) && $this->_aVars['aFeed']['comment_type_id'] == 'poll'): ?> js_parent_module_feed_<?php echo $this->_aVars['aFeed']['comment_type_id'];  endif; ?> <?php if (! empty ( $this->_aVars['aFeed']['custom_class'] )):  echo $this->_aVars['aFeed']['custom_class'];  endif; ?>">
...
<?php if (Phpfox ::getParam('feed.enable_check_in') && Phpfox ::getParam('core.google_api_key') != '' && ! empty ( $this->_aVars['aFeed']['location_name'] ) && isset ( $this->_aVars['aFeed']['location_latlng'] ) && isset ( $this->_aVars['aFeed']['location_latlng']['latitude'] )): ?>
