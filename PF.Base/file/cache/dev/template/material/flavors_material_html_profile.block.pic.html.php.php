...
<?php if (Phpfox ::getUserId() == $this->_aVars['aUser']['user_id']): ?>
				...
				<form action="#">
					<label class="btn-primary btn-gradient" onclick="$Core.ProfilePhoto.update(<?php if ($this->_aVars['sPhotoUrl']): ?>'<?php echo $this->_aVars['sPhotoUrl']; ?>'<?php else: ?>false<?php endif; ?>, <?php echo $this->_aVars['iServerId']; ?>)"><span class="ico ico-camera"></span></label>
...
<?php if (! empty ( $this->_aVars['aUser']['country_child_id'] )): ?>
                                &nbsp;<?php echo Phpfox::getService('core.country')->getChild($this->_aVars['aUser']['country_child_id']); ?>,
<?php endif; ?>
<?php if (! empty ( $this->_aVars['aUser']['location'] )): ?>
...
<?php if (Phpfox ::getParam('user.enable_relationship_status') && isset ( $this->_aVars['sRelationship'] ) && $this->_aVars['sRelationship'] != ''): ?><span><?php echo $this->_aVars['sRelationship']; ?></span><?php endif; ?>
