...
<?php if (defined ( 'PHPFOX_IS_PAGES_VIEW' ) && $this->_aVars['aPage']['is_admin'] && $this->_aVars['aPage']['page_id'] != Phpfox ::getUserBy('profile_page_id') && ( $this->_aVars['aPage']['item_type'] == 0 )): ?>
                ...
                <a data-toggle="dropdown" role="button" class="">
                  ...
                  <span class="txt-label"><?php echo Phpfox::getLib('phpfox.parse.output')->shorten(Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aPage']['full_name']), 15, '...'); ?></span>
...
<?php endif; ?>
          ...
          <div class="activity_feed_form_button_position_button">
            <button type="submit" value="<?php echo _p('share'); ?>"  id="activity_feed_submit" class="button btn btn-gradient btn-sm btn-primary"><span class="ico ico-paperplane hide"></span><span><?php echo _p('share'); ?></span></button>
          </div>
<?php if (isset ( $this->_aVars['aFeedCallback']['module'] )): ?>
<?php else: ?>
...
<?php Phpfox::getBlock('privacy.form', array('privacy_name' => 'privacy','privacy_type' => 'mini','btn_size' => 'sm')); ?>
<?php endif; ?>
<?php endif; ?>
        </div>
