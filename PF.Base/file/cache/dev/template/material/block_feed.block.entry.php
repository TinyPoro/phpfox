...
<?php if (( isset ( $this->_aVars['sponsor'] ) && $this->_aVars['sponsor'] ) || ( isset ( $this->_aVars['aFeed']['sponsored_feed'] ) && $this->_aVars['aFeed']['sponsored_feed'] )): ?>sponsor<?php endif; ?> _app_<?php echo $this->_aVars['aFeed']['type_id']; ?> js_parent_feed_entry js_user_feed" id="js_item_feed_<?php echo $this->_aVars['aFeed']['feed_id']; ?>" <?php if (! empty ( $this->_aVars['bForceFlavor'] )): ?>data-force-flavor="material"<?php endif; ?>>
