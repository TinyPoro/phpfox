...
class Feed_Service_Process extends Phpfox_Service
{
    ...
    public function deleteFeed($iId, $sModule = null, $iItem = 0)
    {
        ...
        if (in_array($aFeed['type_id'], ['photo', 'user_status'])) {
            if (Phpfox::hasCallback($aFeed['type_id'], 'deleteFeedItem')) {
