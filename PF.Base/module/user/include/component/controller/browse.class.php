    ...
    public function process()
    {
		...
		$aFilters = array(
		    ...
		    'type' => array(
			    'type' => 'select',
			    'options' => array(
				    '0' => array(_p('email_name'), 'AND ((u.full_name LIKE \'%[VALUE]%\' OR (u.email LIKE \'%[VALUE]@%\' OR u.email = \'[VALUE]\' OR u.user_name = \'[VALUE]\'))' . (defined('PHPFOX_IS_ADMIN_SEARCH') ? ' OR u.email LIKE \'%[VALUE]\'' : '') .')'),
