            ...
            <div class="panel-body">
                ...
                <div class="form-group"{if $bIsEdit} style="display:none;"{/if}>
                    ...
                    <select id="var_type" name="val[var_type]" class="var_type form-control" required>
                        <option value="">{_p var='select'}:</option>
                        <option value="textarea"{value type='select' id='var_type' default='textarea'}>{_p var='text_area'}</option>
                        <option value="text"{value type='select' id='var_type' default='text'}>{_p var='text_input_60_characters_max'}</option>
                ...
                <div class="form-group">
                    ...
                    {if $bIsEdit && isset($aForms.name) && Phpfox::isPhrase('$aForms.name')}
