...
{/foreach}
	<div class="{if is_int($phpfox.iteration.gateways/2)}row1{else}row2{/if}{if $phpfox.iteration.gateways == 1} row_first{/if}">
		...
		<div class="p_4 gateway_bottom_action">
			{if $aGateway.gateway_id == 'activitypoints'}
			<div class="item-title">{_p var='purchase_points_info' yourpoints=$aGateway.yourpoints|number_format yourcost=$aGateway.yourcost|number_format}</div>
			{/if}
