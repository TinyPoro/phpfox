...
class Phpfox_Setting
{
    ...
    public static function getENVConfigNames()
    {
        return [
            ...
            'core.verify_email_at_signup' => 'PFE_FORCE_EMAIL_VER',
    ...
    public function set()
    {
        ...
        if (defined('PHPFOX_INSTALLER') OR !($aRows = $oCache->getLocalFirst($iId))) {
    ...
    {
        if (is_string($key) && isset($this->configFile[$key])) {
